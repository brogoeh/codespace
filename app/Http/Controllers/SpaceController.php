...
class SpaceController extends Controller
{
    ...
    public function store(Request $request)
    {
       ...
       return redirect()->route('space.index')->with('status', 'Your spaces has been created!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($space->user_id == $request->user()->id){
            ...
            return redirect()->route('space.index')->with('status', 'update data successfully!');
        }
        return redirect()->back()->with('status', 'Updating failed, please check your input data!');
    }
    ...
    public function destroy($id)
    {
        ...
        if($space->user_id == Auth::user()->id){
            ...
            $space->delete();
            return redirect()->route('space.index')->with('status', 'delete data successfully!');
        }
        return redirect()->back()->with('status', 'delete data unsuccessfully');
    }
}
